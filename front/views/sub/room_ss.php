...
<script src="<?=FRONT_JS_DIR?>/common.js"></script>  
			...
			jQuery(function($){
				...
				$.supersized({
					...
					slides 					:  	[			// Slideshow Images
														{image : '<?=FRONT_IMG_DIR?>/sub/room_01.jpg', title : ''},
														{image : '<?=FRONT_IMG_DIR?>/sub/room_02.jpg', title : ''},
														{image : '<?=FRONT_IMG_DIR?>/sub/room_03.jpg', title : ''},
														{image : '<?=FRONT_IMG_DIR?>/sub/room_04.jpg', title : ''},
														{image : '<?=FRONT_IMG_DIR?>/sub/room_05.jpg', title : ''},
														{image : '<?=FRONT_IMG_DIR?>/sub/room_06.jpg', title : ''},
														{image : '<?=FRONT_IMG_DIR?>/sub/room_07.jpg', title : ''},
														{image : '<?=FRONT_IMG_DIR?>/sub/room_08.jpg', title : ''}
												],
	...
	<!--Control Bar-->
	<div id="controls-wrapper" class="load-item" style="margin:0 auto; height:42px; width:100%; bottom:110px; left:0; z-index:4; repeat-x; position:fixed;">
		<div id="controls">
